			  ...
			  <h3>Your Details </h3>
			   ...
			   <table class="table">
			    <br> 
			   	<tr>
			   		<td><b>ID </b></td>
			   		<td><?php $id=$this->session->userdata("users")['id'];
			   		print_r($id); ?></td>
			   	</tr>
			   	<tr>
			   		<td><b>Username </b></td>
			   		<td><?php $username=$this->session->userdata("users")['username'];
			   		print_r($username); ?></td>
			   	</tr>
			   	<tr>
			   		<td><b>First Name </b></td>
			   		<td><?php $firstname=$this->session->userdata("users")['firstname'];
			   		print_r($firstname); ?></td>
			   	</tr>
			   	<tr>
			   		<td><b>Last Name </b></td>
			   		<td><?php $lastname=$this->session->userdata("users")['lastname'];
			   		print_r($lastname); ?></td>
			   	</tr>
			   	<tr>
			   		<td><b>Address </b></td>
			   		<td><?php $address=$this->session->userdata("users")['address'];
			   		print_r($address); ?></td>
			   	</tr>
			   	<tr>
			   		<td><b>Mail ID </b></td>
			   		<td><?php $email=$this->session->userdata("users")['email'];
			   		print_r($email); ?></td>
			   	</tr>
			   	<tr>
			   		<td><b>Contact no.</b></td>
			   		<td><?php $contactno=$this->session->userdata("users")['contactno'];
			   		print_r($contactno); ?></td>
			   	</tr>
			   	<tr>
			   		<td><b>Gender </b></td>
			   		<td><?php $gender=$this->session->userdata("users")['gender'];
			   		print_r($gender); ?></td>
			   	</tr>
			   	<tr>
			   		<td><b>Date Of Birth </b></td>
			   		<td><?php $dob=$this->session->userdata("users")['dob'];
			   		print_r($dob); ?></td>
			   	</tr>
